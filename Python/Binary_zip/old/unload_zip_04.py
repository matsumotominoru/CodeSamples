...
if __name__ == '__main__':
    ...
    with open(zip_file_name, 'rb') as zip_file:
        while(True):
            ...
            print(f'version = {version}, bit flag = {bit_flag}, compression method is {compression_method}, last modification date-time is {last_modification_date} {last_modification_time}')
