// ATLClient.cpp : WinMain のインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f ATLClientps.mak を実行してください。
...
#include "ATLClient_i.c"

// ClientDlgを呼び出すには次の行を追加する必要があります
#include "ClientDlg.h"
    ...
    HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nShowCmd*/)
{
    ...
    _Module.Init(ObjectMap, hInstance, &LIBID_ATLCLIENTLib);
    ...
    while (lpszToken != NULL)
    {
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_ATLClient, FALSE);
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_ATLClient, TRUE);
