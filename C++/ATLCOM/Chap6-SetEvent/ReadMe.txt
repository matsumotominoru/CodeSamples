========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : SetEvent
========================================================================


AppWizard が生成した SetEvent には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには SetEvent を構成している各ファイルの概要説明が含まれています。
...
SetEvent.h
    ...
    みます） をインクルードし、また CSetEventApp アプリケーションクラスを宣
    言します。

SetEvent.cpp
    このファイルは CSetEventApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\SetEvent.ico
    ...
    ルです。このアイコンはリソース ファイル SetEvent.rc によってインクルード
    されます。
...
SetEventDlg.h, SetEventDlg.cpp - ダイアログ
    これらのファイルは CSetEventDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な SetEvent.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) SetEvent.pch 
