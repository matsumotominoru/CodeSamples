// EventWatcher.cpp : WinMain のインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f EventWatcherps.mak を実行してください。
    ...
    HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nShowCmd*/)
{
    ...
    _Module.Init(ObjectMap, hInstance, &LIBID_EVENTWATCHERLib);
    ...
    while (lpszToken != NULL)
    {
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_EventWatcher, FALSE);
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_EventWatcher, TRUE);
