...
BEGIN_COM_MAP(CComDialog)					// ..ADD
	...
	COM_INTERFACE_ENTRY_AGGREGATE(IID_ICalcEaster, m_pAgg.p)	// ..ADD
END_COM_MAP()								// ..ADD
	...
	HRESULT FinalConstruct()
	{
		...
		if (Create(NULL))
		{
			...
			return CoCreateInstance(CLSID_CalcEaster,
				GetUnknown(),
